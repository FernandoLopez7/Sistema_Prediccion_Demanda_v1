...
export default function ProductReplenishmentHistoryPage() {
  ...
  const fetchMovements = async () => {
    try {
      const res = await fetch("/api/stock-movements?entity=product&type=IN");
        ...
        <div>
          ...
          {info.row.original.product?.code && (
            <div className="text-sm text-gray-500">
              Código: {info.row.original.product.code}
            </div>
          )}
        </div>
      ),
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900">
            Historial de Reabastecimientos - Productos
          </h1>
        </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Historial completo de reabastecimientos de productos
                </p>
              </div>
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Buscar por producto, código, sucursal o notas..."
                  value={globalFilter}
